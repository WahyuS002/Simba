...
class Home extends CI_Controller
{
    ...
    public function kategori_lomba($id)
    {
        ...
        // $config['base_url'] = site_url("home/kategori_lomba/$id"); //site url
        // $config['total_rows'] = $this->db->count_all('tb_lomba', ['id_lomba' => $id]); //total row
        // $config['per_page'] = 4;  //show record per halaman
        // $config["uri_segment"] = 3;  // uri parameter
        // $choice = $config["total_rows"] / $config["per_page"];
        // $config["num_links"] = floor($choice);
        ...
        // $data['lomba'] = $this->lomba_list->get_lomba_kategori_list($id, $config["per_page"], $data['page']);
