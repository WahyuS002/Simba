        ...
        <div class="row">
            ...
            <div class="col-lg-4 mt-4 ml-3">
                <div class="form-group">
                    <input type="text" class="form-control" id="judul" name="judul" aria-describedby="emailHelp" placeholder="Judul Lomba">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="hadiah" name="hadiah" aria-describedby="emailHelp" placeholder="Hadiah">
                </div>
